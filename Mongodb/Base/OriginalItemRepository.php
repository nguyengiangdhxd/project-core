...
/**
 * Base class of repository of Mongodb\OriginalItem document.
 */
abstract class OriginalItemRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\OriginalItem';
        $this->isFile = false;
        $this->collectionName = 'original_item';
