...
/**
 * Base class of repository of Mongodb\ItemVariant document.
 */
abstract class ItemVariantRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\ItemVariant';
        $this->isFile = false;
        $this->collectionName = 'item_variants';
