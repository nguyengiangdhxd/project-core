...
/**
 * Base class of repository of Mongodb\UserProfiles document.
 */
abstract class UserProfilesRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\UserProfiles';
        $this->isFile = false;
