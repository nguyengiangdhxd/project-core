...
/**
 * Base class of repository of Mongodb\OriginalItemVariant document.
 */
abstract class OriginalItemVariantRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\OriginalItemVariant';
        $this->isFile = false;
        $this->collectionName = 'original_item_variant';
