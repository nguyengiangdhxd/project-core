...
/**
 * Base class of repository of Mongodb\ItemsSalePriceFile document.
 */
abstract class ItemsSalePriceFileRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\ItemsSalePriceFile';
        $this->isFile = false;
        $this->collectionName = 'items_sale_price_file';
