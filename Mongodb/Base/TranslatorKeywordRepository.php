...
/**
 * Base class of repository of Mongodb\TranslatorKeyword document.
 */
abstract class TranslatorKeywordRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\TranslatorKeyword';
        $this->isFile = false;
        $this->collectionName = 'keyword_search';
