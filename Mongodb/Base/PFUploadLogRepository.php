...
/**
 * Base class of repository of Mongodb\PFUploadLog document.
 */
abstract class PFUploadLogRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\PFUploadLog';
        $this->isFile = false;
        $this->collectionName = 'pf_upload_log';
