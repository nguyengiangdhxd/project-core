...
/**
 * Base class of repository of Mongodb\CustomerProfiles document.
 */
abstract class CustomerProfilesRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\CustomerProfiles';
        $this->isFile = false;
        $this->collectionName = 'customer_profiles';
