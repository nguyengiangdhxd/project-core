...
/**
 * Base class of Mongodb\TranslatorKeyword document.
 */
abstract class TranslatorKeyword extends \Mandango\Document\Document implements \ArrayAccess
{
    /**
     ...
     *
     * @return \Mongodb\TranslatorKeyword The document (fluent interface).
     */
