...
/**
 * Base class of repository of Mongodb\TranslatorTitleKeyword document.
 */
abstract class TranslatorTitleKeywordRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Mongodb\TranslatorTitleKeyword';
        $this->isFile = false;
        $this->collectionName = 'title_translate';
